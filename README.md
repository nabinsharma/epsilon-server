...
Epsilon-server is my personal work that uses dejavu under the
hood.

Go to [dejavu project](https://github.com/worldveil/dejavu).

Rest of this document is exact copy of
[README from dejavu](https://github.com/worldveil/dejavu/blob/master/README.md).
